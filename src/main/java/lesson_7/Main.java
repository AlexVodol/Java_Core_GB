...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        while (true) {
            ...
            System.out.println("На данный момент в "
                    + weatherResponse.getGeoObjectObject().getLocalityObject().getName() + " "
                    + weatherResponse.getFactObject().getTemp() + " C и " + weatherResponse.getFactObject().getCondition());
        }
    }
}
